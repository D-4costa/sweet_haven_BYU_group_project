  ...
  return (
    <main>
      ...
      <section className="highlight">
        <h2 className="title">Why Choose Sweet Haven</h2>
        <p style={{ maxWidth: "600px", margin: "0 auto" }}>
          We connect passionate bakers with dessert lovers. Every product is
          handcrafted with care, ensuring quality, freshness, and a unique
